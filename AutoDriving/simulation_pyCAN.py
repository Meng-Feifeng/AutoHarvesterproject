...
def lqr_steering_control(state, cx, cy, cyaw, ck, pe, pth_e):
    ...
    # ind, e = Stan.calc_target_index(state, cx, cy, cyaw)
...
def main():
    ...
    t, x, y, yaw, v = closed_loop_prediction(cx, cy, cyaw, ck, v_target/3.6, goal)
...
def main2():
    ...
    closed_loop_prediction(DB.cx, DB.cy, DB.cyaw, DB.ck, v_target/3.6, goal)
